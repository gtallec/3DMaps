...
class Planet:
    ...
    def __init__(self, id, latNb, lonNb, diameter, verticalResolution = 1, horizontalResolution = 1, amplitude = 1):
        self.id = id
        self.latNb = latNb
        self.lonNb = lonNb
        self.diameter = diameter
        self.altitudes = AltitudesGenerator.AltitudesGenerator().generateAltitudes(latNb, lonNb, verticalResolution, horizontalResolution, amplitude)
